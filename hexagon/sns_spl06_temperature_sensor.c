...
static void spl06_publish_attributes(sns_sensor * const this)
{
    ...
    spl06_state *state = (spl06_state*)this->state->state;
    {
        ...
        range1[0].flt = SPL06_SENSOR_TEMPERATURE_RANGE_MIN;
        range1[1].has_flt = true;
        range1[1].flt = SPL06_SENSOR_TEMPERATURE_RANGE_MAX;
    ...
    }
    {
        ...
        values[0].has_sint = true;
        values[0].sint = SPL06_SENSOR_TEMPERATURE_LOW_POWER_CURRENT;
        values[1].has_sint = true;
        values[1].sint = SPL06_SENSOR_TEMPERATURE_NORMAL_POWER_CURRENT;
    ...
    }
    {
        sns_std_attr_value_data values[] = {SNS_ATTR};
        values[0].has_flt = true;
        values[0].flt = SPL06_SENSOR_TEMPERATURE_RESOLUTION;
    ...
    }
    {
        sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
        value.has_sint = true;
        value.sint = SPL06_SENSOR_TEMPERATURE_SLEEP_CURRENT;
        sns_publish_attribute(
...
{
    spl06_state *state = (spl06_state*) this->state->state;
    SPL_SENSOR_LOG(LOW, this, "<sns_see_if__ init>temperature sensor init");
    state->sensor = SPL06_TEMPERATURE;
